    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      if (rsq < cutsq[itype][jtype]) {
        ...
        de[i] += deltaE;
	   	...
	   	//printf("fpair= %g, fvisc = %g, fi = %g, fj = %g, wfd = %g, de = %g\n", fpair, fvisc, fi, fj, wfd, de[i]);
//	   	printf("fpair= %g, imass = %g, jmass = %g, fi = %g, fj = %g, wfd = %g, de = %g\n", fpair, imass, jmass, fi, fj, wfd, de[i]);
