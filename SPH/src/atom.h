...
class Atom : protected Pointers {
 public:
  ...
  double *rho,*drho,*e,*de,*cv,*dphi;
  double *phi, *csound;
  double **colorgradient;
  double **vest;

  int epsilon_flag_, sigma_flag_, dSigma_flag_, epsilonBar_flag_, R_flag_, tau_flag_, dTau_flag_, p_flag_, viscosity_flag_, artStress_flag_;
  double ***epsilon_; // 
  double ***sigma_, ***dSigma_; //
  double ***artStress_; //
  double ***epsilonBar_; //
  double ***R_; // 
  double *** tau_; //
  ...
  double **xOld_; int xOld_flag_;
  double **vOld_; int vOld_flag_;
  double *rhoOld_; int rhoOld_flag_;
  double *phiOld_; int phiOld_flag_;
  double *eOld_; int eOld_flag_;
  double ***tauOld_; int tauOld_flag_;
//  double ***sigmaOld_; int sigmaOld_flag_;
