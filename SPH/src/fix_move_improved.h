...
FixStyle(move/improved,FixMoveImproved)

#else

#ifndef LMP_FIX_MOVE_IMPROVED_H
#define LMP_FIX_MOVE_IMPROVED_H
...
class FixMoveImproved : public Fix {
 public:
  FixMoveImproved(class LAMMPS *, int, char **);
  ~FixMoveImproved();
  int setmask();
  void init();
 ...
 private:
  ...
  char *vxvarstrlinear, *vyvarstrlinear, *vzvarstrlinear;
  int mstyle;
